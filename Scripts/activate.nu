...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Funix\My project\Nam Project\python\taiToaDo'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Funix\My project\Nam Project\python\taiToaDo\Scripts\deactivate.nu'
